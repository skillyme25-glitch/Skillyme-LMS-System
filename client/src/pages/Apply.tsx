...
export default function ApplyPage() {
  ...
  const [form, setForm] = useState({
    ...
    confirmProgram: false, confirmIP: false, confirmFee: false, confirmAccuracy: false,
  ...
  const canNext: Record<number, boolean> = {
    ...
    5: !!(form.confirmProgram && form.confirmIP && form.confirmFee && form.confirmAccuracy),
  };
